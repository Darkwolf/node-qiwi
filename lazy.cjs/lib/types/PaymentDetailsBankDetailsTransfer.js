...
class PaymentDetailsBankDetailsTransfer extends types.PaymentDetails {
  constructor(options = {}) {
    super(options)
    this
...
PaymentDetailsBankDetailsTransfer.fromParams = (params = {}) => {
  const data = {
...
PaymentDetailsBankDetailsTransfer.from = options => new PaymentDetailsBankDetailsTransfer(options)

module.exports = PaymentDetailsBankDetailsTransfer
