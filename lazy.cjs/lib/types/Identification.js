...
class Identification {
  ...
  get isAnonymous() {
    return this.type === constants.IdentificationType.ANONYMOUS
  }

  get isSimple() {
    return this.type === constants.IdentificationType.SIMPLE
  }

  get isVerified() {
    return this.type === constants.IdentificationType.VERIFIED
  }

  get isFull() {
    return this.type === constants.IdentificationType.FULL
  }
