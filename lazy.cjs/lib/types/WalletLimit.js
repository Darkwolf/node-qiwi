...
class WalletLimit {
  ...
  get isRefill() {
    return this.type === constants.WalletOperationType.REFILL
  }

  get isTurnover() {
    return this.type === constants.WalletOperationType.TURNOVER
  }

  get isPaymentsP2P() {
    return this.type === constants.WalletOperationType.PAYMENTS_P2P
  }

  get isPaymentsProviderInternationals() {
    return this.type === constants.WalletOperationType.PAYMENTS_PROVIDER_INTERNATIONALS
  }

  get isPaymentsProviderPayout() {
    return this.type === constants.WalletOperationType.PAYMENTS_PROVIDER_PAYOUT
  }

  get isWithdrawCash() {
    return this.type === constants.WalletOperationType.WITHDRAW_CASH
  }
